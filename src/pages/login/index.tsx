...
const CustomSignupForm: React.FC = () => {
  ...
  return (
    <div className="bg-[#E4EDE9] p-4 h-full">
      <div className="container mx-auto flex h-full justify-center items-center ">
        <div className="flex flex-col justify-center items-center border py-12 px-8 rounded-2xl bg-white sm:w-full md:w-1/2 lg:w-1/3 xl:w-1/3 relative">
